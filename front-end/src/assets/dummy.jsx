...
export const INPUTWRAPPER =
    "flex gap-1 items-center border border-purple-100 rounded-lg px-3 py-2.5 focus-within:ring-2 focus-within:ring-purple-500 focus-within:border-purple-500 transition-all duration-200"
...
export const LINK_CLASSES = {
    ...
    icon: "transition-transform duration-300 group-hover:scale-110 text-purple-500 pr-1",
...
export const STATS_GRID = "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4 mb-4 md:mb-6"
...
// Filter options
export const FILTER_OPTIONS = ["all", "today", "week", "high", "low"]
