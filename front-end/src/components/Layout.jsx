...
const Layout = ({ onLogout, user }) => {
  ...
  const fetchTasks = useCallback(async () => {
    ...
    try {
      ...
      const { data } = await axios.get("https://fullstack-task-manager-assignment-backend.onrender.com/api/tasks/gp", {
  ...
  if (loading)
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="animate-spin w-12 h-12 rounded-full border-t-2 border-b-2 border-purple-500" />
      </div>
    );
            ...
            <div className="bg-white rounded-xl p-4 sm:p-5 shadow-sm border border-purple-100">
              ...
              <div className="space-y-2 sm:space-y-3">
                <div className="flex items-center justify-between text-gray-700">
                  ...
                  <span className="text-xs bg-purple-1000 text-purple-700 px-1.5 py-0.5 sm:px-2 rounded-full">
              ...
              <div className="space-y-2 sm:space-y-3">
                {tasks.slice(0, 3).map((task) => (
                  <div
                    ...
                    className="flex items-center justify-between p-2 sm:p-3 hover:bg-purple-50/50 rounded-lg transitionn-colors duration-200 border border-transparent hover:border-purple-100"
                  >
                    ...
                    <span className={`px-2 py-1 text-xs rounded-full shrink-0 ml-2 ${task.completed ? 'bg-green-700' : 'bg-fuchsia-100 text-fuchsia-700'}`}>
