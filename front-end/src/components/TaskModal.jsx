...
const API_BASE = "https://fullstack-task-manager-assignment-backend.onrender.com/api/tasks";
    ...
    <div className=" inset-0 fixed backdrop:blur-sm bg-black/20 z-50 flex items-center justify-center p-4">
      <div className=" bg-white border border-purple-100 rounded-xl max-w-md w-full shadow-lg relative p-6 animate-fadeIn ">
        ...
        <form onSubmit={handleSubmit} className=" space-y-4">
          ...
          className=" w-full bg-gradient-to-r from-fuchsia-500 to-purple-500 text-white font-medium py-2.5 px-4 rounded-lg flex items-center justify-center gap-2 disabled:opacity-50 hover:shadow-md transition-all duration-200">
